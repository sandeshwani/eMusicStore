...
<div class="container-wrapper">
    <div class="container">
        ...
        <div class="form-group">
            <label for="name">Name</label><form:errors path="productName" cssStyle="color: #761c19"></form:errors>
        ...
        <div class="form-group">
            <label for="price">Price</label><form:errors path="productPrice" cssStyle="color: #761c19"></form:errors>
        ...
        <div class="form-group">
            <label for="unitInStock">Unit In Stock</label><form:errors path="unitInStock" cssStyle="color: #761c19"></form:errors>
